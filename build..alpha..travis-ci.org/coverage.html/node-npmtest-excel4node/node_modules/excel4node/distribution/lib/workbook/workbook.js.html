...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-excel4node/node_modules/excel4node/distribution/lib/workbook/workbook.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/workbook/workbook.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">71.05% <small>(54 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/workbook/</a> &#187; workbook.js</div>
</div>
<div class="body">
...
&nbsp;
        this.logger = new SlothLogger.Logger({
            logLevel: Number.isNaN(parseInt(opts.logLevel)) ? 0 : <span class="branch-1 cbranch-no" title="branch not covered" >parseInt(opts.logLevel)</span>
        });
&nbsp;
...
&nbsp;
    _createClass(Workbook, [{
        key: 'setSelectedTab',
        value: <span class="fstat-no" title="function not covered" >function setSelectedTab(id) {</span>
<span class="cstat-no" title="statement not covered" >            this.sheets.forEach(<span class="fstat-no" title="function not covered" >function (s) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (s.sheetId === id) {</span>
<span class="cstat-no" title="statement not covered" >                    s.opts.sheetView.tabSelected = 1;</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    s.opts.sheetView.tabSelected = 0;</span>
                }
            });
        }
&nbsp;
...
&nbsp;
        ...
        key: 'writeToBuffer',
        value: <span class="fstat-no" title="function not covered" >function writeToBuffer() {</span>
<span class="cstat-no" title="statement not covered" >            return builder.writeToBuffer(this);</span>
        }
&nbsp;
        /**
         * Generate .xlsx file.
...
&nbsp;
        ...
        key: 'write',
        value: <span class="fstat-no" title="function not covered" >function write(fileName, handler) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            builder.writeToBuffer(this).then(<span class="fstat-no" title="function not covered" >function (buffer) {</span></span>
<span class="cstat-no" title="statement not covered" >                switch (typeof handler === 'undefined' ? 'undefined' : _typeof(handler)) {</span>
                    // handler passed as http response object.
&nbsp;
                    case 'object':
<span class="cstat-no" title="statement not covered" >                        if (handler instanceof http.ServerResponse) {</span>
<span class="cstat-no" title="statement not covered" >                            handler.writeHead(200, {</span>
                                'Content-Length': buffer.length,
                                'Content-Type': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                                'Content-Disposition': 'attachment; filename="' + fileName + '"'
                            });
<span class="cstat-no" title="statement not covered" >                            handler.end(buffer);</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            throw new TypeError('Unknown object sent to write function.');</span>
                        }
<span class="cstat-no" title="statement not covered" >                        break;</span>
&nbsp;
                    // handler passed as callback function
                    case 'function':
<span class="cstat-no" title="statement not covered" >                        fs.writeFile(fileName, buffer, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >                            if (err) {</span>
<span class="cstat-no" title="statement not covered" >                                handler(err);</span>
                            } else {
<span class="cstat-no" title="statement not covered" >                                fs.stat(fileName, handler);</span>
                            }
                        });
<span class="cstat-no" title="statement not covered" >                        break;</span>
&nbsp;
...
&nbsp;
        ...
        value: function getStringIndex(val) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.sharedStrings.indexOf(val) &lt; 0) {
