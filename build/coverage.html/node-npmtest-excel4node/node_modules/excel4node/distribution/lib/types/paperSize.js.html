...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-excel4node/node_modules/excel4node/distribution/lib/types/paperSize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/types/paperSize.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.36% <small>(74 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/types/</a> &#187; paperSize.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    if (this[val.toUpperCase()] === undefined) {</span>
...
<span class="cstat-no" title="statement not covered" >        throw new TypeError('Invalid value for PAPER_SIZE; Value must be one of ' + this.opts.join(', '));</span>
    } else {
