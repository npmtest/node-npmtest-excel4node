...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-excel4node/node_modules/excel4node/distribution/lib/worksheet/worksheet.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/worksheet/worksheet.js</span></h1>
    <h2>
        ...
        Functions: <span class="metric">55.56% <small>(10 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-excel4node/node_modules/excel4node/distribution/lib/worksheet/</a> &#187; worksheet.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        optsValidator(opts);
&nbsp;
        this.opts.sheetView.tabSelected = this.sheetId === 1 ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
        this.name = name ? name : <span class="branch-1 cbranch-no" title="branch not covered" >'Sheet ' + this.sheetId;</span>
...
&nbsp;
         ...
         * @returns {Worksheet}
         */
        value: <span class="fstat-no" title="function not covered" >function addConditionalFormattingRule(sqref, options) {</span>
<span class="cstat-no" title="statement not covered" >            var style = options.style || this.wb.Style();</span>
<span class="cstat-no" title="statement not covered" >            var dxf = this.wb.dxfCollection.add(style);</span>
<span class="cstat-no" title="statement not covered" >            delete options.style;</span>
<span class="cstat-no" title="statement not covered" >            options.dxfId = dxf.id;</span>
<span class="cstat-no" title="statement not covered" >            this.cfRulesCollection.add(sqref, options);</span>
...
&nbsp;
        ...
        value: <span class="fstat-no" title="function not covered" >function addDataValidation(opts) {</span>
<span class="cstat-no" title="statement not covered" >            var newValidation = this.dataValidationCollection.add(opts);</span>
<span class="cstat-no" title="statement not covered" >            return newValidation;</span>
        }
        /**
...
&nbsp;
        ...
        key: 'generateRelsXML',
        value: <span class="fstat-no" title="function not covered" >function generateRelsXML() {</span>
<span class="cstat-no" title="statement not covered" >            return xmlBuilder.relsXML(this);</span>
        }
        /**
...
&nbsp;
        ...
        key: 'generateXML',
        value: <span class="fstat-no" title="function not covered" >function generateXML() {</span>
<span class="cstat-no" title="statement not covered" >            return xmlBuilder.sheetXML(this);</span>
        }
    }, {
        key: 'row',
...
<span class="cstat-no" title="statement not covered" >            var newImage = this.drawingCollection.add(opts);</span>
<span class="cstat-no" title="statement not covered" >            newImage.id = mediaID;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            this.hyperlinkCollection.links.forEach(<span class="fstat-no" title="function not covered" >function (l) {</span></span>
<span class="cstat-no" title="statement not covered" >                rels.push(l);</span>
            });
<span class="cstat-no" title="statement not covered" >            if (!this.drawingCollection.isEmpty) {</span>
<span class="cstat-no" title="statement not covered" >                rels.push('drawing');</span>
            }
<span class="cstat-no" title="statement not covered" >            return rels;</span>
        }
    }, {
        key: 'columnCount',
        get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >            return Math.max.apply(Math, Object.keys(this.cols));</span>
        }
    }, {
        key: 'rowCount',
        get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >            return Math.max.apply(Math, Object.keys(this.rows));</span>
        }
    }, {
        key: 'cell',
        get: function get() {
